...
const SLACK_REDIRECT_URI = window.location.origin + '/slack-callback.html';
...
// Check for Slack OAuth code on page load
...
async function exchangeCodeForToken(code) {
    try {
        const response = await fetch('YOUR_BACKEND_TOKEN_EXCHANGE_ENDPOINT', {
            method: 'POST',
            headers: {
...
function updateUserInterface(userInfo) {
    if (userInfo) {
        ...
        document.getElementById('employeeEmail').value = userInfo.email;
    }
}
